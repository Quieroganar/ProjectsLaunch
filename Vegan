...
/**
 * El primer proyecto Vegano del mundo BlockChain
 * El unico limite es la imaginación y en mano queda cambiar el mundo
 * 
 */

import "./vegan-imports.sol";

/**
 * Gracias por participar en el proyecto VeganCoin y favorecer el cambio. 
 */
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Vegancoin";
    string internal constant SYMBOL = "VEGAN";
    ...
    uint256 internal constant TOTAL_SUPPLY = 210000000 * ZEROES;
    ...
    address internal marketing = 0xfc794F96107B4A25f89C3924303e7e45043B89d8;
    address internal inversiones = 0x41B5269d1C0eFdF8D3dF2abc9ef267fEFdC4f886;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 20, inversiones );
